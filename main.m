...
% end
testfilename = ['NTDS1.xlsx'; 'MUSA1.xlsx'; 'MUSA2.xlsx'];
for i = 1 : 3
    [data, len(i ,1)] = getData(testfilename(i, :));
    DATA(1:len(i, 1), i) = data;
end
for  i = 1 : 3
    figure;
    plot(DATA(:, i), '-r');
    title([testfilename(i, :),'失效及其发生时间']);
end
% a1 = 1.25;
% a2 = 5.02;
% b1 = 0.0192;
% b2 = 0.0584;
% t = 20
Ft1= getFt(DATA(:, 1), 1.25, 5.02, 0.0192, 0.0584, 20, len(1, 1));
Uplot(Ft1);
